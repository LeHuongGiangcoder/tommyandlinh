...
export default function Home() {
  ...
  const handleOpenEnvelope = () => {
    ...
    // 2. Flowers remain elegant or can have a subtle scale pulse if desired
    // (Float animation starts soon after flap opens)

    // 3. Flowers Elegantly Drift Out and Fade (0.8-2.0s)
          ...
          <div className="relative flex items-center justify-center animate-in fade-in zoom-in duration-1000">
            ...
            <div className="relative w-[340px] h-[240px] md:w-[500px] md:h-[350px] bg-surface shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] flex items-center justify-center border border-burgundy/5 overflow-visible">
              ...
              <div className="relative z-50 flex flex-col items-center">
                ...
                <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 pointer-events-none z-[60] animate-hand-point opacity-0 hand-hint">
                  <div className="relative">
                    {/* Tap Ripple/Lines Effect (Clustered at fingertip) */}
                    <svg className="absolute -top-3 -left-3 w-8 h-8 opacity-0 animate-tap-hint" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round">
                      <path d="M12 3V6M18 7l-2 2M6 7l2 2" className="animate-pulse" />
                    </svg>

                    <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-90 drop-shadow-[0_8px_16px_rgba(0,0,0,0.4)] rotate-[-10deg]">
